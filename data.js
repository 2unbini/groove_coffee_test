var q = {
    ...
    9 : {
        type: "SN",
        title: "9.  지나가다 들른 카페 분위기가 좋을 때 나는?",
        A: "\"와 여기 정말 좋다\", 직관적으로 감정을 말한다.",
        B: "\"조명이 따뜻해서 마음이 편안해져\", 구체적으로 이유를 말한다."
    },
    10 : {
        type: "IH",
        title: "10.  카페에 가면 나는?",
...
var result = {
    ...
    "DBSI": {
            "drink": "딸기 바나나 스무디",
            "summary": "상큼 발랄한 당신!",
            "explain": "‣ 달콤하고 상큼한 딸기 바나나 스무디와 잘 어울리는 당신은 유쾌하고 사랑스러운 사람이에요.<br>‣ 그 누구보다 따뜻한 마음씨를 가진 당신은 주변 사람들을 소중히 하는군요.<br>‣ 풍부한 사회성과 친절한 성격을 가지고 있으며, 구체적이고 현실적인 방법으로 타인을 돕고자 해요.",
            "dessert": "버터 스콘",
